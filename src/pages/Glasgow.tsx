...
import GlasgowTestimonials from '@/components/GlasgowTestimonials';
import Process from '@/components/Process';
import Tools from '@/components/Tools';
import GlasgowCTA from '@/components/GlasgowCTA';
          ...
          <div className="container px-6 mx-auto">
            <div ref={heroRef} className={`max-w-4xl mx-auto transition-all duration-700 delay-300 transform ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <h1 className="heading-xl mb-6 text-center md:text-left">
                Glasgow's Leading <span className="shimmer-text">CRO Agency</span> For Data-Driven Results
              </h1>
              
              <p className="body-lg text-muted-foreground mb-8 text-center md:text-left">
                The CRO Lab helps Glasgow businesses optimize their websites to convert more visitors into customers through scientific testing and data analysis.
              </p>
          ...
          <div className="container px-6 mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium rounded-full bg-palette-magenta text-white border border-palette-magenta">
                Glasgow Success Stories
              </span>
              <h2 className="heading-lg mb-6">
                Case studies from Glasgow clients
              </h2>
              <p className="body-md text-muted-foreground">
                See how we've helped other Glasgow businesses achieve remarkable results through conversion rate optimization.
              </p>
            </div>
