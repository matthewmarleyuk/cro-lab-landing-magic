...
const Edinburgh = () => {
  useEffect(() => {
    ...
    document.title = 'CRO Agency Edinburgh - The CRO Lab';
    // Add meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'The CRO Lab Edinburgh helps local businesses optimize their websites to convert more visitors into customers through scientific testing and data analysis.');
    }
  }, []);
