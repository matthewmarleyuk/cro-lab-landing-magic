...
import BirminghamAbout from '@/components/BirminghamAbout';
import BirminghamServices from '@/components/BirminghamServices';
import BirminghamTestimonials from '@/components/BirminghamTestimonials';
import Process from '@/components/Process';
import Tools from '@/components/Tools';
import BirminghamCTA from '@/components/BirminghamCTA';
...
const Birmingham = () => {
  useEffect(() => {
    ...
    document.title = 'CRO Agency Birmingham - The CRO Lab';
    // Add meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'The CRO Lab Birmingham helps local businesses optimize their websites to convert more visitors into customers through scientific testing and data analysis.');
    }
  }, []);
  ...
  const caseStudies = [{
    ...
    title: "Birmingham Tourism Company",
    industry: "Travel",
          ...
          <div className="container px-6 mx-auto">
            <div ref={heroRef} className={`max-w-4xl mx-auto transition-all duration-700 delay-300 transform ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <h1 className="heading-xl mb-6 text-center md:text-left">
                Birmingham's Leading <span className="shimmer-text">CRO Agency</span> For Data-Driven Results
              </h1>
              
              <p className="body-lg text-muted-foreground mb-8 text-center md:text-left">
                The CRO Lab helps Birmingham businesses optimize their websites to convert more visitors into customers through scientific testing and data analysis.
              </p>
          ...
          <div className="container px-6 mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="heading-lg mb-6">
                Case studies from Birmingham clients
              </h2>
              <p className="body-md text-muted-foreground">
                See how we've helped other Birmingham businesses achieve remarkable results through conversion rate optimization.
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <Button className="rounded-full px-6 py-6 text-base bg-palette-purple hover:bg-palette-purple/90">
                View All Birmingham Case Studies
                <ChevronRight className="ml-1 h-5 w-5" />
              </Button>
            </div>
          </div>
