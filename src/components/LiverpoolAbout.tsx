        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium rounded-full bg-palette-magenta text-white border border-palette-magenta">
                About Our Liverpool Agency
              </span>
              <h2 className="heading-lg mb-6">
                Liverpool's dedicated CRO specialists
              </h2>
            </div>
            ...
            >
              <p className="body-md mb-6 text-muted-foreground">
                Based in the heart of Liverpool, The CRO Lab serves the city's thriving business community with specialized conversion rate optimization services. We understand the unique challenges faced by Liverpool businesses in the digital landscape.
              </p>
              <p className="body-md text-muted-foreground">
                Our Liverpool team combines local market knowledge with global best practices in CRO to deliver tailored solutions that drive measurable results for businesses across all sectors – from Liverpool's tech startups to established tourism enterprises.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="rounded-xl p-6 text-white border shadow-md hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#D90368' }}>
              ...
              <p className="text-sm text-white/90">Our Liverpool-based team understands the local market dynamics and customer behaviors.</p>
            </div>
            ...
            <div className="rounded-xl p-6 text-white border shadow-md hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#270A56' }}>
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">Liverpool Focus</h3>
              <p className="text-sm text-white/90">Specialized strategies that work for Liverpool's unique business landscape.</p>
            </div>
            ...
            <div className="rounded-xl p-6 text-white border shadow-md hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#270A56' }}>
              ...
              <p className="text-sm text-white/90">Strong relationships with Liverpool's business community and tech ecosystem.</p>
            </div>
            ...
            <div className="rounded-xl p-6 text-white border shadow-md hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#D90368' }}>
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">Liverpool ROI</h3>
              <p className="text-sm text-white/90">Proven track record of delivering ROI for Liverpool-based businesses.</p>
            </div>
          </div>
        </div>
      </div>
