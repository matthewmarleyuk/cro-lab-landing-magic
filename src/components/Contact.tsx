...
const Contact = () => {
  ...
  const { ref: formRef, isVisible: formVisible } = useFadeIn(0.1);
  const { ref: infoRef, isVisible: infoVisible } = useFadeIn(0.1);
  ...
  const benefits = [
    ...
    'Direct communication with optimization experts'
  ];
    ...
    <section id="contact" className="py-16 md:py-20 bg-secondary/50 relative">
      <div className="container px-6 mx-auto">
        ...
        <div className="grid md:grid-cols-5 gap-10 max-w-5xl mx-auto">
          <div 
            ref={formRef}
            className={`md:col-span-3 glass-card rounded-xl p-6 md:p-8 transition-all duration-700 delay-400 transform ${
          ...
          <div 
            ref={infoRef} 
            className={`md:col-span-2 transition-all duration-700 delay-600 transform ${
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => (
                  <li key={index} className="flex">
                    <CheckCircle className="h-5 w-5 text-cro-700 mr-3 flex-shrink-0" />
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@thecrolab.com" className="text-sm text-muted-foreground hover:text-foreground transition-smooth">
                      hello@thecrolab.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+14155552671" className="text-sm text-muted-foreground hover:text-foreground transition-smooth">
                      (415) 555-2671
                    </a>
                  </div>
                </div>
