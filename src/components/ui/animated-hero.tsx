...
function Hero() {
  ...
  return <div className="w-full relative min-h-screen flex items-center pt-6 pb-2 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-0 left-0 right-0 h-full bg-gradient-to-b from-secondary/85 to-background"></div>
        <div className="absolute top-40 right-20 w-72 h-72 rounded-full bg-palette-purple/20 filter blur-3xl"></div>
        <div className="absolute bottom-40 left-20 w-80 h-80 rounded-full bg-palette-magenta/20 filter blur-3xl"></div>
        {/* Additional decorative elements */}
        <div className="absolute top-1/4 left-1/3 w-64 h-64 rounded-full bg-palette-yellow/10 filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-48 h-48 rounded-full bg-palette-purple/15 filter blur-2xl"></div>
      </div>
