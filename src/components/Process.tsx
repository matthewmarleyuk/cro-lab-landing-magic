...
const Process = () => {
  ...
  } = useStaggeredAnimation(steps, 150);
  return <section id="process" className="py-16 md:py-20 relative overflow-hidden">
      <div className="container px-6 mx-auto">
        ...
        <div ref={stepsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {steps.map((step, index) => <div key={step.title} className={`rounded-xl p-8 transition-all duration-500 transform text-white border shadow-md hover:shadow-lg relative z-10 ${stepsVisible[index] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{
