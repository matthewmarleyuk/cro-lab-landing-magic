  ...
  return (
    <section className="py-20 md:py-28 bg-background">
      <Container>
        ...
        >
          <div className="text-center p-8 rounded-xl bg-[#270A56] shadow-md border border-[#270A56]/20 transition-all duration-300 hover:shadow-xl hover:translate-y-[-8px] hover:bg-[#270A56]/90">
