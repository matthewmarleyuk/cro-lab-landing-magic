  ...
  const testimonials = [
    {
      ...
      company: "Birmingham Tech Solutions",
      stars: 5,
      quote: "The CRO Lab transformed our website performance. Their Birmingham expertise helped us understand our local audience and our conversion rates increased by 85% in three months.",
      image: "/placeholder.svg"
    },
    {
      name: "David Thompson",
      position: "E-commerce Manager",
      company: "Birmingham Retail Group",
      stars: 5,
      quote: "Their Birmingham-focused approach to CRO delivered exceptional results. Our cart abandonment rate dropped by 40% and our average order value increased significantly.",
      image: "/placeholder.svg"
    },
    {
      name: "Michelle Lewis",
      position: "Digital Director",
      company: "Birmingham Tourism Board",
      stars: 5,
      quote: "Working with a CRO agency that understands Birmingham's unique market made all the difference. Our booking conversion rate nearly doubled since implementing their recommendations.",
      image: "/placeholder.svg"
    }
  ];
      ...
      <div className="container px-6 mx-auto">
        ...
        >
          ...
          <h2 className="heading-lg mb-6 text-balance">
            What Birmingham businesses say about our CRO services
          </h2>
          <p className="body-md text-muted-foreground text-balance">
            Don't just take our word for it - hear from our satisfied Birmingham clients who have transformed their conversion rates.
          </p>
        </div>
