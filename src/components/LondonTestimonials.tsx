...
const LondonTestimonials = () => {
  ...
  const testimonials = [{
    ...
    position: "Marketing Director, LondonTech",
    ...
    name: "Fiona MacLeod",
    position: "E-commerce Manager, London Retail",
    ...
    position: "Digital Director, LondonHealth",
      ...
      <div className="container px-6 mx-auto">
        <div ref={titleRef} className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-700 delay-200 transform ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="heading-lg mb-6 text-balance">
            What London businesses say about our CRO expertise
          </h2>
          <p className="body-md text-muted-foreground text-balance px-0">
            See how we've helped London businesses overcome conversion challenges and achieve significant growth.
          </p>
        </div>
