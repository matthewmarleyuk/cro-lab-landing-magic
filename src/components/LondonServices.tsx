...
const LondonServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Advanced analytics setup and tracking specifically for London website traffic.",
    ...
    },
    {
      ...
      description: "Comprehensive review of your London business's digital conversion strategy.",
