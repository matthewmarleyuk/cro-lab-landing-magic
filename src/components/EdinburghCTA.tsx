      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white text-balance">
            Ready to optimise your Edinburgh website?
          </h2>
          
          <p className="text-lg text-white/90 mb-8 text-balance">
            Let our Edinburgh CRO specialists help you convert more visitors into customers with data-driven optimisation strategies.
          </p>
